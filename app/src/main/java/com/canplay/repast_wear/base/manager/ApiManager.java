...
import com.canplay.repast_wear.base.config.BaseConfig;
import com.canplay.repast_wear.base.config.NetConfig;
import com.canplay.repast_wear.net.FastJsonConverterFactory;
import com.canplay.repast_wear.net.HttpCachInterceptor;
import com.canplay.repast_wear.net.MarvelSignInterceptor;
import com.canplay.repast_wear.util.CryptUtil;
...
public class ApiManager{
    ...
    public static Map<String, String> getParameters(Map<String, String> parametersMap, boolean isPost){
        ...
        parametersMap.put("platform", "3"); //手表
