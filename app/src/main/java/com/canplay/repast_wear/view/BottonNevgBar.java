...
public class BottonNevgBar extends LinearLayout implements View.OnClickListener {
    ...
    public void setSelect(int index){
        ...
        if (index==0){
            imageViews[0].setImageResource(R.drawable.b1);
            imageViews[1].setImageResource(R.drawable.b22);
            imageViews[2].setImageResource(R.drawable.b33);
            imageViews[3].setImageResource(R.drawable.b44);

        }else if (index==1){
            imageViews[0].setImageResource(R.drawable.b11);
            imageViews[1].setImageResource(R.drawable.b2);
            imageViews[2].setImageResource(R.drawable.b33);
            imageViews[3].setImageResource(R.drawable.b44);
            ...
            imageViews[0].setImageResource(R.drawable.b11);
            imageViews[1].setImageResource(R.drawable.b22);
            imageViews[2].setImageResource(R.drawable.b3);
            imageViews[3].setImageResource(R.drawable.b44);
            ...
            imageViews[1].setImageResource(R.drawable.b22);
            imageViews[2].setImageResource(R.drawable.b33);
            imageViews[3].setImageResource(R.drawable.b4);
